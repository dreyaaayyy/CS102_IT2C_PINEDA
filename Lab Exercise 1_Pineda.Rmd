...
ScrapedProdDetails <- function(link) 
...
ScrapedName <- ScrapeNodes("div.a-row product-title")[1:10]
      
ScrapedReviewer <- ScrapeNodes("span.a-profile-name")[1:10]

ScrapedReview <- ScrapeNodes("span.cr-translated-review-content")[1:10]
      
ScrapedDate <- ScrapeNodes("span.review-date")[1:10]

ScrapedProductRating <- ScrapeNodes("div.a-row")[1:10]

Product1 <- rbind(Product1, data.frame(Category = ScrapedCategory,
                Name = rep(ScrapedName, each = 10),
...
scrape(SessionProd1) %>%
  ...
  html_text(trim = TRUE)
      ...
      ScrapedName <- ScrapeNodes("h1.a-size-large.a-spacing-none")[1:10]
