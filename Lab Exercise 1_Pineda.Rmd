...
Link1_1 = "https://www.amazon.co.uk/Drop-Womens-Addison-Handle-Chocolate/product-reviews/B09GW13FN4/ref=cm_cr_dp_d_show_all_btm?ie=UTF8&reviewerType=all_reviews" 

SessionProd1 <- bow(Link1_1, user_agent = "Educational Purpose")
...
ScrapedName <- ScrapeNodes("div.a-size-large.a-spacing-none.a-color-secondary")
ScrapedName <- ScrapedName[1:10]
...
ScrapedProductRating <- ScrapeNodes("div.a-row")
ScrapedProductRating <- ScrapedProductRating[1:10]
...
Product1 <- rbind(Product1, data.frame(Category = ScrapedCategory,
                ...
                Date = ScrapedDate,
                Ratings = ScrapedProductRating))

###
      
Link1_2 = "https://www.amazon.co.uk/Drop-Womens-Addison-Handle-Chocolate/product-reviews/B09GW13FN4/ref=cm_cr_getr_d_paging_btm_next_2?ie=UTF8&reviewerType=all_reviews&pageNumber=2"

SessionProd2 <- bow(Link1_2, user_agent = "Educational Purpose")  
...
ScrapedProdRating2 <- ScrapeNodes("div.a-row.a-spacing-none")
...
Link1_3 = "https://www.amazon.co.uk/Drop-Womens-Addison-Handle-Chocolate/product-reviews/B09GW13FN4/ref=cm_cr_getr_d_paging_btm_next_3?ie=UTF8&reviewerType=all_reviews&pageNumber=3"

SessionProd3 <- bow(Link1_3, user_agent = "Educational Purpose")  
...
ScrapedProdRating3 <- ScrapeNodes("div.a-row.a-spacing-none")
...
Link2_1 = "https://www.amazon.co.uk/Miss-Lulu-Leather-Stylish-Shoulder/product-reviews/B07DD8GGNX/ref=cm_cr_dp_d_show_all_btm?ie=UTF8&reviewerType=all_reviews" 

SessionProd1 <- bow(Link2_1, user_agent = "Educational Purpose")
...
Link2_2 = "https://www.amazon.co.uk/Miss-Lulu-Leather-Stylish-Shoulder/product-reviews/B07DD8GGNX/ref=cm_cr_arp_d_paging_btm_next_2?ie=UTF8&reviewerType=all_reviews&pageNumber=2"

SessionProd2 <- bow(Link2_2, user_agent = "Educational Purpose")  
      ...
      Product2 <- rbind(Product2, data.frame(Category = ScrapedCategory, 
                          Name = ScrapedName,
                          Reviewer = ScrapedReviewer2,
                          Review = ScrapedReview2,
                          Date = ScrapedDate2,
...
Link2_3= "https://www.amazon.co.uk/Miss-Lulu-Leather-Stylish-Shoulder/product-reviews/B07DD8GGNX/ref=cm_cr_arp_d_paging_btm_next_3?ie=UTF8&reviewerType=all_reviews&pageNumber=3"

SessionProd3 <- bow(Link2_3, user_agent = "Educational Purpose")  
...
SessionProd1 <- bow(Link3_1, user_agent = "Educational Purpose")
...
scrape(SessionProd1) %>%
  ...
  html_text(trim = TRUE)
      ...
      Product3 <- rbind(Product3, data.frame(Category = ScrapedCategory,Name = ScrapedName,
                          Reviewer = ScrapedReviewer,
                          Review = ScrapedReview,
                          Date = ScrapedDate,
                         Ratings = ScrapedRating))
...
SessionProd2 <- bow(Link3_2, user_agent = "Educational Purpose")  
      ...
      Product3 <- rbind(Product3, data.frame(Category = ScrapedCategory, 
                          Name = ScrapedName,
                          Reviewer = ScrapedReviewer2,
                          Review = ScrapedReview2,
                          Date = ScrapedDate2,
...
SessionProd3 <- bow(Link3_3, user_agent = "Educational Purpose")  
...
SessionProd1 <- bow(Link4_1, user_agent = "Educational Purpose")
...
Product4 <- rbind(Product4, data.frame(Category = ScrapedCategory,Name = ScrapedName,
                          Reviewer = ScrapedReviewer,
                          Review = ScrapedReview,
                          Date = ScrapedDate,
                         Ratings = ScrapedRating))
...
SessionProd2 <- bow(Link4_2, user_agent = "Educational Purpose")  
...
Product4 <- rbind(Product4, data.frame(Category = ScrapedCategory, 
                          Name = ScrapedName,
                          Reviewer = ScrapedReviewer2,
                          Review = ScrapedReview2,
                          Date = ScrapedDate2,
...
SessionProd3 <- bow(Link4_3, user_agent = "Educational Purpose")  
